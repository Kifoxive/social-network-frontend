...
const Product = ({
   ...
   // when it isn`t a full version of the product, we don`t have to know all information about product, such as user._id,
   // only user (user is a product`s owner user._id)
   const isOwner = (isFullProduct) ? (userData?._id === user._id) : (userData?._id === user)
